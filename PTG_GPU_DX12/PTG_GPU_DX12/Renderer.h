...
const UINT DENSITY_THREAD_GROUPS_X = 6U; //22 Thread groups * 10 is the absolute maximum because of the vertex buffer
const UINT DENSITY_THREAD_GROUPS_Y = 6U;
const UINT DENSITY_THREAD_GROUPS_Z =	6U;
