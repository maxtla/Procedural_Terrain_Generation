...
public:
	...
	struct Texture3DDesc
	{
		...
		D3D12_TEX3D_UAV tex3D_UAV = { 0U, 0U, DENSITY_THREAD_GROUPS*NUM_THREADS_PER_GROUP };
		D3D12_RESOURCE_DESC resDesc = {
			D3D12_RESOURCE_DIMENSION_TEXTURE3D, //ViewDimension
			0U, //Alignment
			DENSITY_THREAD_GROUPS*NUM_THREADS_PER_GROUP, //Width
			DENSITY_THREAD_GROUPS*NUM_THREADS_PER_GROUP, //Height
			DENSITY_THREAD_GROUPS*NUM_THREADS_PER_GROUP, //Depth
			1U, //MipLevels
